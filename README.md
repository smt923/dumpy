...
## Usage
Simply run the binary on the system to gather information from, the results are printed to stdout so you can easily pipe it somewhere
...
## Customization
Editing the commands currently requires recompiling the project after editing `commands.go`, I plan to allow some configuration via either a file or stdin in the future (and PRs or requests for more defaults are welcome)
